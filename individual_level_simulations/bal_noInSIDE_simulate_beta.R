# Individual-level simulations with balanced pleiotropy and InSIDE assumption violated
rm(list = ls())
library(data.table)
library(dplyr)
library(MASS)
...
repgrp = temp[4] # Simulation group number (1:8) - 200 simulations are partitioned into 8 groups for parallelization.
...
batch_size = 500 # Simulate individual data 2000 subjects at a time
